const bell = document.querySelector('.btn-notification'),
 ...
 uploadVideo = document.querySelector('[name="uploadVideo"]'),
 cameraBtn = document.querySelector('.profilePic'),
 logoBtn = document.querySelector('.uploadLogo'),
    ...
    if(data.image.includes("http")){
         ...
         html +=   `</div>
                    ...
                    <div class="col-11 col-md-12 mx-auto">
                        <div id="flash" class="my-2"></div>
                        <input type="text" name="fullname" value="${data.fullname}" placeholder="full name" class="form-control">
...
if(uploadVideo) uploadVideo.addEventListener('click', () => {
